...
#define ARCHIVE_VOLUME_EXTENSION ".EPD"

#define ARCHIVE_VOLUME_HEADER_COMMENT_LENGTH 256
#define ARCHIVE_VOLUME_FILE_NAME_LENGTH 64
...
namespace Assets::Archives
{
    ...
    BOOL ArchiveVolumeV1EMount(ArchiveVolume* self, const char* name, InStreamFile* stream, char* outMessage)
    {
